...
description: "Solid.js best practices for AI-assisted code generation, code review, refactoring, and debugging reactivity issues. Use when writing Solid.js components, auditing SolidJS code, migrating from React to Solid, or fixing signals and fine-grained reactivity bugs. 49 rules across 8 categories (reactivity, components, control flow, state management, refs/DOM, performance, accessibility, testing) ranked by priority."
license: MIT
allowed-tools:
  - Read
  - Grep
...
| [8-4](rules/8-4-handle-async-in-tests.md)                        | Async queries, timers, and empty state patterns |
